...
NSString * const kVMPythonAidemModuleProgressFileName = @"vm_progress";
...
@implementation VMPythonAidemModule
...
- (void)downloadWithURLString:(NSString *)urlString
                ...
                preferredName:(NSString *)preferredName
                   completion:(VMPythonAidemModuleDownloadingCompletion)completion
{
  [self _loadKYVideoDownloaderModuleIfNeeded];
